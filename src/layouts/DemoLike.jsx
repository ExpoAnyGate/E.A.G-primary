...
export default function DemoLike() {
  ...
  return (
    <>
      <div className="demo-special py-4 px-6 bg-gray-100 rounded-4">
        <h2 className="fs-5 fw-700 text-gray-700 mb-4">你可能會喜歡</h2>
        <div className="d-flex flex-column gap-4 w-100">
          {/* <Link to={`/demo/2`} className="text-decoration-none text-dark">
            <div className="demo-card d-flex flex-column">
              <div className="demo-small-info d-flex justify-content-between align-items-center  bg-gray-000 rounded-top-2 w-100 px-6 py-4">
                <div>
                  <p className="fs-4 fw-400">2024/8/15 - 2024/9/15</p>
                </div>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <span className="nowrap">台北市</span>
                </div>
              </div>
              ...
              <div className="demo-small-info d-flex flex-column justify-content-between bg-gray-000 rounded-bottom-2 w-100 p-6 gap-4">
                ...
                <div className="demo-small-title d-flex flex-column gap-4">
                  <p className="fs-8 fw-700">現代設計的未來：數位藝術展</p>
          ...
          <Link to={`/demo/1`} className="text-decoration-none text-dark">
            <div className="demo-card d-flex flex-column">
              <div className="demo-small-info d-flex justify-content-between bg-gray-000 rounded-top-2 w-100 px-6 py-4">
                <div>
                  <p className="fs-4 fw-400">2024/8/15 - 2024/9/15</p>
                </div>
              ...
              <div className="demo-small-info d-flex flex-column justify-content-between bg-gray-000 rounded-bottom-2 w-100 p-6 gap-4">
                ...
                />
                <div className="demo-small-title d-flex flex-column gap-4">
                  <p className="fs-8 fw-700">藝術中的女性力量</p>
          ...
          {exhibitions.map((exhibition, index) => (
            <Link key={index} to={`/demo/${exhibition.id}`} className="text-decoration-none text-dark">
              <div className="demo-card d-flex flex-column">
                <div className="demo-small-info d-flex justify-content-between align-items-center bg-gray-000 rounded-top-2 w-100 px-6 py-4">
                  <div>
