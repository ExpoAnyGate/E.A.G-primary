            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content border-0">
                  ...
                  <ul className="row">
                    <li className="col-4">
                      <span className="h-100 d-flex flex-column justify-content-center">
                        <img
                          src="../assets/images/lgoo-Dark.png"
                          alt="logo-Dark"
                        />
                      </span>
                    </li>
                ...
                <div className="modal-footer justify-content-start border-0 pb-10 position-relative overflow-hidden">
                  <img
                    src="../assets/images/deco/linegp-lg-1.png"
                    alt="linegp-lg-1"
                    className="position-absolute z-1 start-0 top-0"
                  />
                  <ul className="row gy-5 position-relative z-2">
                    <li className="col-12">
                      <h3 className="fs-5 text-gray-500 mb-2">快速成為探索者</h3>
                      <h3 className="fs-5 text-gray-500">蒐藏個人專屬的展覽！</h3>
                    </li>
                    <li className="col-12">
