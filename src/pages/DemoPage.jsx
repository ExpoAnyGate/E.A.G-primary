...
export default function DemoPage() {
  ...
  return (
    <>
      <div className="demo-banner mt-bp-140-0"></div>

      <div className="container">
        <div className="demo-top w-100 d-flex gap-4 mt-17">
          <div className="main-demo">
            <div className="border border-gray-700 rounded-3 p-10">
              <div className="demo-card-header d-flex flex-column">
                <div className="demo-title d-flex align-items-center">
                  <p className="fs-12 fw-bold me-2">{demo.title}</p>
                  {/* <span
                    id="bookmark-icon"
                    className="material-symbols-outlined fs-6 px-0 demo-bookmark"
                  >
                    bookmark_add
                  </span> */}
                  <span
              ...
              <ul className="demo-info d-flex flex-column gap-3 mt-6">
              ...
              <ul className="action-icons d-flex gap-6 mt-6">
                <li className="d-flex align-items-center gap-2">
                  <span className="material-symbols-outlined p-0 demo-favorite fs-6">
                    favorite
                  </span>
                  <span>{demo.likes}</span>
                </li>
                <li className="d-flex align-items-center gap-2">
                  <span className="material-symbols-rounded p-0 fs-6">
                    visibility
                  </span>
              ...
              <a className="btn btn-gray-700 mt-8 rounded-8 w-100 demo-button">
                我要參加
              </a>
            </div>

            <div className="main-demo-special">
            ...
            <div className="demo-detail">
              <div className="mt-17 ">
                <div className="position-relative d-inline">
                  <h2 className="fs-9 fw-700 text-gray-700 position-relative z-2 d-inline">
                    活動簡介
                  </h2>
                  <img
                    className="position-absolute z-0 demo-title-underline"
                    src="deco/line-4.png"
                    alt="line-3"
                  />
                </div>
              ...
              <div className="mt-8 p-10 bg-secondary-100 rounded-2 d-flex flex-column gap-4">
                <h4 className="fs-6 fw-700">活動亮點</h4>
                <ul className="d-flex flex-column gap-4 demo-highlight fs-5 fw-700">
                  <li>
                    創作互動：
                    <p className="ps-7 fs-4 fw-400 pt-1">
                  ...
                  <li>
                    限量藝術品抽獎：
                    <p className="ps-7 fs-4 fw-400 mt-1">
              ...
              <div className="d-flex flex-column gap-4 mt-8">
                <h2 className="fs-5 fw-700">注意事項</h2>
                <ol className="d-flex flex-column gap-1 demo-notice">
              ...
              <div className="mt-17 ">
                ...
                <div className="demo-cast d-flex gap-14 mt-10">
                  <div className="d-flex flex-column align-items-center gap-2">
                    <img src="Demo/cast01.png" alt="" />
                    <p className="fs-5 fw-700">小智</p>
                  </div>
                  <div className="d-flex flex-column align-items-center gap-2">
                    <img src="Demo/cast02.png" alt="" />
                    <p className="fs-5 fw-700">小霞</p>
                  </div>
                  <div className="d-flex flex-column align-items-center gap-2">
                    <img src="Demo/cast03.png" alt="" />
                    <p className="fs-5 fw-700">小剛</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="demo-map mt-17 mb-17">
          <div className="position-relative d-inline">
            <h2 className="fs-9 fw-700 text-gray-700 position-relative z-2 d-inline">
              活動地圖
            </h2>
